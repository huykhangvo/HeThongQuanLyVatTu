              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    ...
                    if ($row['quyen'] == 0) {
                      echo "<label>";
                      echo "<input type='radio' name='level' class='minimal' value='0' checked>
                      Quản lý";
                      echo "<label>";

                      echo "<lable>";
                      echo "<input type='radio' name='level' class='minimal' value='1'> Giảng viên quản lý phòng máy";
                      echo "</lable>";

                      echo "<lable>";
                      echo "<input type='radio' name='level' class='minimal' value='2'> Giảng viên";
                      echo "</lable>";
                    } else if ($row['quyen'] == 1) {
                      echo "<label>";
                      echo "<input type='radio' name='level' class='minimal' value='0'>
                      Quản lý";
                      echo "<label>";

                      echo "<lable>";
                      echo "<input type='radio' name='level' class='minimal' value='1' checked> Giảng viên quản lý phòng máy";
                      echo "</lable>";
                      ...
                      echo "<lable>";
                      echo "<input type='radio' name='level' class='minimal' value='2' checked> Giảng viên";
                      echo "</lable>";
                    }
                    ?>
                  </div>
