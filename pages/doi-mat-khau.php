              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" method="POST">
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label" style="height: 10px; font-size: 12px;">Nhập mật khẩu cũ <b style="color: red;">*</b></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label" style="height: 10px; font-size: 12px;">Nhập mật khẩu mới <b style="color: red;">*</b></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label" style="height: 10px; font-size: 12px;">Nhập lại mật khẩu mới <b style="color: red;">*</b></label>
                    <div class="col-sm-10">
