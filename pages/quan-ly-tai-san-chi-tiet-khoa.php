...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
    ...
    // Muốn thêm mà $id = '1"; = id_donvi  cntt
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" ><a href="quan-ly-tai-san-khoa.php?p=quanly&a=khoa">Khoa</a></li>
            ...
            <section class="content-header">
                <div class="list-itemmm">
                    ...
                    <div class="itemK" data-toggle="modal" data-target="#themPhong">
                        <img src="../dist/images/add.png" width="50">
                    ...
                    ?>
                        ...
                        <div class="itemK2">
                            ...
                            <a href="nhat-ky-phong-may-khoa.php?nhatky=nkpm&id=<?php echo $row['id_tructhuoc'] ?>">
                                <div class="abcde">
