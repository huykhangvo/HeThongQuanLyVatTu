                    ...
                    ?>
                      <tr>
                        ...
                        <th>
                          ...
                          } else if ($arrS['quyen'] == 1) {
                            echo "<span class='label label-success'>Giảng viên quản lý phòng máy</span>";
                          } else if ($arrS['quyen'] == 2) {
                            echo "<span class='label label-warning'>Giảng viên</span>";
                          }
                          ?>
                        </th>
                        <th>
                        ...
                        <th>
                          <?php
                          if ($row_acc['quyen'] == 0 || $row_acc['quyen'] == 1) {
