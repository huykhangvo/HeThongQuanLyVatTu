    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" ><a href="quan-ly-tai-san-trung-tam.php?p=quanly&a=khoa">Trung tâm</a></li>
                ...
                <div class="list-itemmm">
                    ...
                    ?>
                        ...
                        <div class="itemK2">
                            ...
                            <a href="nhat-ky-phong-may-trung-tam.php?nhatky=nkpm&id=<?php echo $row['id_tructhuoc'] ?>">
                                <div class="abcde">
